  ...
  return (
    ...
    <main className="space-y-6">
      <section className="flex  flex-wrap gap-3 justify-between items-center">
        ...
        <button onClick={showAddForm} className="flex cursor-pointer grow sm:grow-0 items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
